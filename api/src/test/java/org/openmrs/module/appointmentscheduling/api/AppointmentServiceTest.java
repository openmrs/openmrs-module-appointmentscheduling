...
public class AppointmentServiceTest extends BaseModuleContextSensitiveTest {
	...
	@Test
	@Verifies(value = "should get all appointments", method = "getAllPatientAppointments()")
	public void getAllPatientAppointments_shouldgetAllPatientAppointments() throws Exception {
		List<PatientAppointment> appointments = service.getAllPatientAppointments();
		assertEquals(TOTAL_APPOINTMENTS, appointments.size());
	}

	@Test
	@Verifies(value = "should get correct appointment", method = "getPatientAppointment(Integer)")
	public void getAppointment_shouldGetCorrectAppointment() throws Exception {
		PatientAppointment appointment = service.getPatientAppointment(1);
		assertNotNull(appointment);
		assertEquals("c0c579b0-8e59-401d-8a4a-976a0b183601",
				appointment.getUuid());

		appointment = service.getPatientAppointment(2);
		assertNotNull(appointment);
		assertEquals("c0c579b0-8e59-401d-8a4a-976a0b183602",
				appointment.getUuid());

		appointment = service.getPatientAppointment(3);
		assertNotNull(appointment);
		assertEquals("c0c579b0-8e59-401d-8a4a-976a0b183603",
				appointment.getUuid());

		appointment = service.getPatientAppointment(15);
		assertNull(appointment);
	}

	@Test
	@Verifies(value = "should get correct appointment", method = "getPatientAppointmentByUuid(String)")
	public void getPatientAppointmentByUuid_shouldGetCorrectAppointment()
			throws Exception {
		PatientAppointment appointment = service
				.getPatientAppointmentByUuid("c0c579b0-8e59-401d-8a4a-976a0b183601");
		assertNotNull(appointment);
		assertEquals((Integer) 1, appointment.getId());

		appointment = service
				.getPatientAppointmentByUuid("c0c579b0-8e59-401d-8a4a-976a0b183602");
		assertNotNull(appointment);
		assertEquals((Integer) 2, appointment.getId());

		appointment = service
				.getPatientAppointmentByUuid("c0c579b0-8e59-401d-8a4a-976a0b183603");
		assertNotNull(appointment);
		assertEquals((Integer) 3, appointment.getId());

		appointment = service
				.getPatientAppointmentByUuid("c0c579b0-8e59-401d-8a4a-976a0b183700");
		assertNull(appointment);
	}

	@Test
	@Verifies(value = "should save new appointment", method = "savePatientAppointment(Appointment)")
	public void savePatientAppointment_shouldSaveNewAppointment() throws Exception {
		...
		PatientAppointment appointment = new PatientAppointment(timeSlot, new Visit(1),
	...
	@Test
	@Verifies(value = "should save edited appointment", method = "savePatientAppointment(Appointment)")
	public void savePatientAppointment_shouldSaveEditedAppointment() throws Exception {
		PatientAppointment appointment = service.getPatientAppointment(1);
		assertNotNull(appointment);
		assertEquals((Integer) 1, appointment.getId());
		...
		appointment = service.getPatientAppointment(1);
		assertNotNull(appointment);
		assertEquals(AppointmentStatus.MISSED, appointment.getStatus());

		// Should not change the number of appointment types.
		assertEquals(TOTAL_APPOINTMENTS, service.getAllPatientAppointments().size());
	}
	...
	public void voidAppointment_shouldVoidGivenAppointment() throws Exception {
		...
		service.voidPatientAppointment(appointment, "void reason");
	...
	@Test
	@Verifies(value = "should unvoid given appointment", method = "unvoidPatientAppointment(Appointment)")
	public void unvoidPatientAppointment_shouldUnvoidGivenAppointment()
			throws Exception {
		PatientAppointment appointment = service.getPatientAppointment(3);
		assertNotNull(appointment);
		assertTrue(appointment.isVoided());
		assertEquals("some void reason", appointment.getVoidReason());

		service.unvoidPatientAppointment(appointment);
	...
	public void purgeAppointment_shouldDeleteGivenAppointment()
		...
		service.purgePatientAppointment(appointment);

		appointment = service.getPatientAppointment(3);
		assertNull(appointment);

		// Should reduce the existing number of appointment types.
		assertEquals(TOTAL_APPOINTMENTS - 1, service.getAllPatientAppointments()
				.size());
	}

	@Test
	@Verifies(value = "should get all appointments of patient", method = "getAppointmentsOfPatient(Integer patientId")
	public void getAppointmentsOfPatient_shouldgetAllPatientAppointmentsOfPatient()
			throws Exception {
		List<PatientAppointment> appointments = service
	...
	public void getAppointmentByVisit_shouldGetCorrectAppointment() {
		PatientAppointment appointment = service.getAppointmentByVisit(new Visit(1));
	...
	public void shouldGetAllUnvoidedAppointments_getAppointmentsByConstraints() {
		List<PatientAppointment> appointments = service.getAppointmentsByConstraints(
	...
	public void shouldGetAllUnvoidedAppointmentsByADateInterval_getAppointmentsByConstraints()
		...
		PatientAppointment specificAppointment = service.getPatientAppointment(4);
	...
	public void shouldGetAllUnvoidedAppointmentsByType_getAppointmentsByConstraints() {
		...
		PatientAppointment specificAppointment = service.getPatientAppointment(5);
	...
	public void shouldGetCorrectAppointments_getAppointmentsByStatus() {
		...
		PatientAppointment appointment = null;
		List<PatientAppointment> result = null;
		...
		appointment = service.getPatientAppointment(4);
		assertNotNull(appointment);
		assertTrue(result.contains(appointment));
		appointment = service.getPatientAppointment(7);
		assertNotNull(appointment);
		assertTrue(result.contains(appointment));
		...
		assertNotNull(appointment);
		assertTrue(result.contains(appointment));
		appointment = service.getPatientAppointment(5);
		assertNotNull(appointment);
		assertTrue(result.contains(appointment));
	}
	...
	public void shouldChangeCorrectAppointments_cleanOpenAppointments() {
		List<PatientAppointment> result = service.cleanOpenAppointments();
	...
	public void getAppointmentsInTimeSlotThatAreNotCancelled_shouldGetCorrectAppointments() {
		...
		PatientAppointment appointment = service.getPatientAppointment(7);
		assertTrue(appointments.contains(appointment));
		appointment = service.getPatientAppointment(11);
		assertTrue(appointments.contains(appointment));
	}
