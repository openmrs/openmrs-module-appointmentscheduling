...
import static org.openmrs.module.appointmentscheduling.AppointmentData.AppointmentStatus.COMPLETED;
...
public class AppointmentResource1_9ControllerTest
	...
	public void shouldCreateNewAppointmentWithAllFields() throws Exception {
		...
		Assert.assertEquals(getAllCount() + 1, appointmentService
				.getAllAppointmentDatas(false).size());
	...
	public void shouldEditAnAppointment() throws Exception {
		...
		AppointmentData appointment = appointmentService
				.getAppointmentDataByUuid(getUuid());
	...
	public void shouldVoidAnAppointment() throws Exception {
		...
		AppointmentData voided = appointmentService.getAppointmentDataByUuid(getUuid());
