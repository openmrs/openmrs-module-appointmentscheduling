...
@Resource(name = RestConstants.VERSION_1 + AppointmentRestController.APPOINTMENT_SCHEDULING_REST_NAMESPACE + "/appointmentstatushistory",
        supportedClass = AppointmentStatusHistory.class, supportedOpenmrsVersions = {"1.9.* - 9.*"})
public class AppointmentStatusHistoryResource1_9 extends DataDelegatingCrudResource<AppointmentStatusHistory> {
    ...
    protected PageableResult doSearch(RequestContext context) {
        ...
        PatientAppointment appointment = context.getParameter("appointment") != null ? Context.getService(AppointmentService.class)
                .getPatientAppointmentByUuid(context.getParameter("appointment")) : null;
